...
class FreeDayStoreClass extends EventEmitter {
  ...
  removeReadListener(cb) {
    this.removeReadListener(READ_FREE_DAY_EVENT, cb);
  }
  emitRead(){
  ...
  removeSavedListener(cb) {
    this.removeReadListener(SAVED_FREE_DAY_EVENT, cb);
  }
  emitSaved(){
  ...
  removeDeletedListener(cb) {
    this.removeReadListener(DELETED_FREE_DAY_EVENT, cb);
  }
  emitDeleted(){
  ...
  removeErrorListener(cb) {
    this.removeReadListener(ERROR_SAVE_FREE_DAY_EVENT, cb);
  }
  emitError(){
